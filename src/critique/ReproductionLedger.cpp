    ...
    std::vector<ReproductionLedger::Entry> ReproductionLedger::entries()
    {
        return {
            ...
            {"the transformation extends to a group with representations", State::Reproduced,
             "transform/ExtendedIsometryGroup"},
            ...
            {"a massive body can cover distance faster than light with the signature "
             "kept one-time-axis, at the price of an energy condition",
             State::Used, "none"},
            ...
            {"plane waves crossing from a one-time-axis to a split-signature signature propagate, "
            ...
            {"the commutator function of a doubled superluminal sector vanishes",
             State::Reproduced, "critique/ObjectionTests"},
            {"a superluminal excitation would be bounded by vacuum pair emission radiation",
             State::Reproduced, "critique/ObjectionTests"},
            {"the boundary vacuum energy differs between the two signatures", State::Reproduced,
             "quantum/BoundaryVacuumEnergy"},
            {"electromagnetism transforms consistently under the involution",
             State::Reproduced, "field/VectorGaugeField"},
            ...
            {"one-time-axis-Euclidean black holes avoid singularities", State::Context, ""},
            ...
            {"split-signature geometry can be modelled in metamaterials", State::Context, ""},
